  ...
  return (
    <div className="m-6 md:m-12 xl:m-20">
      ...
      <p className="mb-6 text-lg font-normal text-gray-500 lg:text-xl ">
        Welcome to MJM Prints, your one-stop shop for all your printing needs.
        We are a group of passionate, committed professionals with years of
        experience in the printing business. Our goal is to offer our customers
        high-quality printing services at a competitive price.
      </p>
          ...
          <div className="lg:flex flex-row-reverse justify-between items-center gap-12">
            <div className="lg:w-3/4 ">
              ...
              <p className="mb-6 text-lg font-normal text-gray-500 lg:text-xl ">
                ...
                Malu, was a visionary who founded MJM Prints, formerly known as
                Mangala Enterprises, in 1972. He saw the need for dependable and
                high-quality envelopes for use in radiology and general
                hospitals, and this motivated him to set the groundwork for our
                production and printing business. We added multicolor paper
                files and laminated files to our product lineup within a short
                period of time.
              </p>
              <p className="mb-6 text-lg font-normal text-gray-500 lg:text-xl">
                ...
                this industry for 48 years, MJM Prints is delighted to be
      ...
      <div className="lg:w-full ">
        ...
        <p className="mb-6 text-lg font-normal text-gray-500 lg:text-xl ">
          At MJM Prints, we take great pleasure in our dedication to quality and
          client satisfaction. In order to produce the greatest products at the
          most competitive costs, we make use of innovative technology and feel
          out the market needs. We have made a name for ourselves in the
          packaging sector for both for-profit and nonprofit goods and products.
          We are dedicated to providing each and every one of our customers with
          a great experience.
          <br />
          <br />
