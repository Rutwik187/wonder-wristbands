    ...
    <section>
      <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
        <div className="max-w-3xl space-y-3">
          <h3 className="text-[#FF6B66] font-semibold">Blogs</h3>
          <p className="text-[#5E0000] text-3xl font-semibold sm:text-4xl">
            Read some of our Latest Blogs.
          </p>
          <p>
            Read our latest blog posts for informative articles on
            identification wristbands, industry news, and tips on how to use
            wristbands for events, medical purposes, and more.
          </p>
        </div>
            ...
            <article className="p-6 bg-white rounded-lg border border-gray-200 shadow-md ">
              ...
              <div className="flex justify-between items-center">
                <div className="flex items-center space-x-4">
                  <span className="font-medium ">Wonder Wristband</span>
                </div>
                <Link
