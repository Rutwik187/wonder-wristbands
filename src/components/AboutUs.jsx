  ...
  return (
    <section className="cta-sec relative max-w-screen-xl mx-auto py-4 px-4 md:px-8">
      ...
      <div className="relative z-10 gap-5 items-center lg:flex">
        <div className="flex flex-col gap-1 flex-1 max-w-lg py-5 sm:mx-auto sm:text-center lg:max-w-max lg:text-left">
          <h3 className="text-[#FF6B66] font-semibold">About Us</h3>
          <h3 className="text-3xl text-[#5E0000] font-semibold md:text-4xl ">
            Welcome to <span className="text-[#FF6B66]">Wonder WristBand</span>
          </h3>
          <p className="text-gray-500 leading-relaxed mt-2">
            Welcome to Wonder Wristbands, your one-stop shop for all your
